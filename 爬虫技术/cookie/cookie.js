...
const {JSDOM} = jsdom
var dom = new JSDOM('<!DOCTYPE html><p>hello</p>'),window = dom.window,document = window.document,navigator = window.navigator


var TOKEN_SERVER_TIME = 1699066000.404;
var _v = null
!function(n, t) {
    !function() {
        var r, e, a;
