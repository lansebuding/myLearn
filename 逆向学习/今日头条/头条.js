...
const {JSDOM} = jsdom
var dom = new JSDOM('<!doctype html><h1>你好</h1>')
// var window = dom.window,navigator = window.navigator,document=window.document
// var xxxxx = null
var document = dom.window.document
window=global;
var location = dom.window.location
var navigator = dom.window.navigator
// window.referer='https://www.toutiao.com/?wid=1699337755879'
var glb;
...
console.log(window.byted_acrawler.sign({url:'https://www.toutiao.com/api/pc/list/feed?channel_id=0&min_behot_time=1699522359.5849502&offset=0&refresh_count=1&category=pc_profile_recommend&aid=24&app_name=toutiao_web'}));